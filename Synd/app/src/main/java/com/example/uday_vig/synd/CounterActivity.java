...
public class CounterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String purpose = getIntent().getExtras().getString("PURPOSE"); //TODO: Any use?
         ...
         handler.postDelayed(new Runnable() {
             ...
             public void run() {
                 try {
                     ...
                     String URL = "http://192.168.1.11:5000/poll";
                         ...
                         protected Response<String> parseNetworkResponse(NetworkResponse response) {
                             ...
                             if (response != null) {
                                 try {
                                     ...
                                     Log.e("YOLO: CounterActivity", "parseNetworkResponse: " + str);
                                         ...
                                         public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                             ...
                                             if(!counter.equals(recCounter)){
                                                 runOnUiThread(new Runnable() {
                                                     @Override
                                                     public void run() {
                                                         currCounterTextView.setText("You are currently at " + recCounter);
